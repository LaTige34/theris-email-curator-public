...
[![Tests](https://github.com/YourName/email-curator-public/actions/workflows/tests.yml/badge.svg)](https://github.com/YourName/email-curator-public/actions)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

**Version : 0.1.1** — 75 tests verts, zero I/O réseau en test, AI Act art. 50
...
- Reçoit ARS, CPAM, candidatures médecin coordonnateur, prospects pilote,
  LegalPlace, Qonto, infra provider
...
- Routing labels + anti-faux-positifs (13 tests)
...
MIT © 2026 Open Source Contributors — voir [LICENSE](LICENSE).

## Crédits

- Inspiré des patterns de l'écosystème [Anthropic Claude Skills](https://github.com/anthropics/skills)
- Contributeurs open source bienvenus.
- Shout-out aux builders qui libèrent leurs outils — ici on rend la pareille.
